...
var Router = exports.Router = {
   ...
   */
  registerRoute: function registerRoute(component, path, exact) {
    routerRegistry.set(component, { path: path, parser: routeParser(path), exact: !!exact });
   ...
   */
  registerLink: function registerLink(component, url, exact) {
    routerRegistry.set(component, { url: url, parser: linkParser(url), exact: !!exact });
    checkComponent(component);
  },
 ...
 */
var cacheStringFn = function cacheStringFn(fn) {
  var cache = {};
  return function (str) {
    if (!cache[str]) {
      cache[str] = fn(str);
...
var routeParser = cacheStringFn(function (path) {
  ...
  return function (url, exact) {
    ...
    return { active: true, params: params, url: m[1] };
  };
});
/**
...
var linkParser = cacheStringFn(function (path) {
 ...
 * @param {Event} e 
 */
var routerListener = function routerListener(e) {
  urlChanged();
};
/**
 ...
 * the current url
 */
var routerListen = function routerListen() {
  ...
  var path = cleanPath(window.location.pathname).split('/').map(decodeURIComponent).join('/');
 ...
 */
var routerUnlisten = function routerUnlisten() {
  if (!routerListening) return;
...
var Route = exports.Route = function (_React$Component) {
...
var Link = exports.Link = function (_React$Component) {
  ...
  _createClass(Link, [{
    key: 'realTo',
    value: function realTo(props, context) {
      var route = context.route;
      var to = props.to;

      if (route && route.url && !to.startsWith('/')) return route.url + '/' + to;else return to;
    }
  }, {
    key: 'render',
    value: function render() {
...
var NavLink = exports.NavLink = function (_React$Component) {
  ...
  function NavLink(props, context) {
    ...
    var _this = _possibleConstructorReturn(this, (NavLink.__proto__ || Object.getPrototypeOf(NavLink)).call(this, props, context));

    _this.state = { active: false };
    _this.onRouter = function (_ref) {
      var active = _ref.active;

      if (_this.state.active !== active) _this.setState({ active: active });
    };
    return _this;
  }
  ...
  _createClass(NavLink, [{
    ...
    key: 'setup',
    value: function setup(props, context) {
      _Router.Router.registerLink(this, this.realTo(props, context), props.exact);
    }
  }, {
    key: 'render',
    value: function render() {
...
var Redirect = exports.Redirect = function (_React$Component) {
  _inherits(Redirect, _React$Component);

  function Redirect(props, context) {
    _classCallCheck(this, Redirect);

    return _possibleConstructorReturn(this, (Redirect.__proto__ || Object.getPrototypeOf(Redirect)).call(this, props, context));
  }
  ...
  _createClass(Redirect, [{
    ...
    value: function componentDidMount() {
      _Router.Router.redirect(this.realTo(this.props, this.context));
    }
  }, {
    key: 'render',
    value: function render() {
...
function IndexRedirect(props) {
  return _react2.default.createElement(
    _Route.IndexRoute,
    null,
    _react2.default.createElement(Redirect, { to: props.to })
  );
}
...
var _Redirect = __webpack_require__(11);
